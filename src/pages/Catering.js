    ...
    <main>
      ...
      <section>
        ...
        <div className="wrap">
          <CateringPackage>
            ...
            <p>
              Hummous, Fresh Pita Bread, Fatoosh, Grape Leaves, Shish Tawook,
              and Poco Rice.
            </p>
          </CateringPackage>
          <CateringPackage>
          ...
          <CateringPackage>
            ...
            <p>
              ...
              Beef Tenderloin Shish Kabob, Shish Tawook, and Poco Rice.
            </p>
          </CateringPackage>
          <CateringPackage>
            <h5>Poco Mezza &mdash; 40 per person</h5>
            <p>
              Hummous, Fresh Pita Bread, Feta Dip, Fatoosh, Tabouli, Grape
              Leaves, Ara-yes, Chicken Wraps, Beef Tenderloin Shish Kabob, Shish
              Kafta, Shish Tawook, and Poco Rice.
            </p>
          </CateringPackage>
          <CateringPackage>
            <h5>Poco Experience &mdash; 45 per person</h5>
            <p>
              Hummous, Fresh Pita Bread, Feta Dip, Fatoosh, Grape Leaves,
              Brussel Sprouts, Cauliflower, Sauteed Mushrooms, Lamb Chops, Beef
              Tenderloin Shish Kabob, Shish Tawook, and Poco Rice.
            </p>
          </CateringPackage>
          <CateringPackage>
            <h5>Deluxe Package &mdash; 55 per person</h5>
            <p>
              Hummous, Fresh Pita Bread, Feta Dip, Vegetable Tray, Fatoosh,
              Greek Salad, Grape Leaves, Brussel Sprouts, Cauliflower, Sauteed
              Mushrooms, Greek Potatoes, Lamb Chops, Whole Beef Tenderloin
              Filet, and Poco Rice.
            </p>
          </CateringPackage>
          <CateringPackage>
            ...
            <p>
              Hummous, Fatoosh, Veggie Grape Leaves, Brussel Sprouts,
              Cauliflower, Mujadara, Sauteed Mushrooms, Veggie Shish Kabob, and
              Poco Rice.
            </p>
          </CateringPackage>
          <CateringPackage>
          ...
          <CateringPackage>
            ...
            <p>
              Grilled Lamb Sliders, Chicken Parmesan Sliders, Hummous, Fresh
              Pita Bread, and Fatoosh.
            </p>
          </CateringPackage>
          <CateringPackage>
            <p>
              * Packages are intended to be guides. Any and all items may be
              ...
              available for pricing and other packages are available upon
              request.
            </p>
          </CateringPackage>
        </div>
      ...
      <section className="no-padding-top">
        ...
        <div className="wrap">
          <CateringPackage>
            <h5>
              Poco Experience &mdash; 2 Hours/45 per person. 3 Hours/55 per
              person
            </h5>
            <p>
              Top shelf liquor, 3 draft beer options, 2 domestic bottle beer
              options, sangria bar.
            </p>
          </CateringPackage>
          <CateringPackage>
            <h5>
              Poco Mediterranean &mdash; 2 Hours/30 per person. 3 Hours/40 per
              person
            </h5>
            <p>
              Premium liquor, 3 draft beer options, 2 import bottle beer
              options, sangria bar.
            </p>
          </CateringPackage>
          <CateringPackage>
            <h5>
              Sangria Bar &mdash; 2 Hours/15 per person. 3 Hours/25 per person
            </h5>
            <p>White sangria, red sangria, mixed sangria.</p>
          </CateringPackage>
          <CateringPackage>
            <h5>
              Poco Brew &mdash; 2 Hours/15 per person. 3 Hours/25 per person
            </h5>
            <p>
              3 draft beer options, 2 import bottle beer options, 2 domestic
              beer options.
            </p>
          </CateringPackage>
        </div>
