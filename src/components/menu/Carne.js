...
const Carne = () => (
  <div className="Carne">
    ...
    <div className="Outline">
      ...
      <h5>Grilled Baby Lamb Chops &mdash; 15</h5>
      <p>Marinated in balsamic, fresh herbs and garlic, grilled to perfection.</p>
      <h5>Ara-yes Halabi &mdash; Sm 7 Lg 12</h5>
